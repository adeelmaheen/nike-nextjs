...
export default function MensPage() {
    return (
      ...
      <div className="max-w-6xl mx-auto px-4 py-12">
        <h1 className="text-4xl font-bold mb-6">Men's Collection</h1>
        <p>Discover the latest in men's shoes, clothing, and accessories.</p>
      </div>
      <main>
         <div className="w-full flex justify-center items-center mt-10 mb-1 ">
            ...
            <span className='absolute top-1 right-1 text-red rounded-full'><FontAwesomeIcon icon={faHeart} className='text-xl  ' /></span>
                  ...
                  <button className=" w-full absolute bottom-0   bg-black text-white px-4 py-2 rounded-sm opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                    ...
                    <h1 className="font-bold font-sans pt-2 ">Bag</h1>
            ...
            <span className='absolute top-1 right-1 text-red rounded-full'><FontAwesomeIcon icon={faHeart} className='text-xl  ' /></span>
                  ...
                  <button className=" w-full absolute bottom-0   bg-black text-white px-4 py-2 rounded-sm opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                    ...
                    <h1 className="font-bold font-sans pt-2">Girl Shoes</h1>
            ...
            <span className='absolute top-1 right-1 text-red rounded-full'><FontAwesomeIcon icon={faHeart} className='text-xl  ' /></span>
                  ...
                  <button className=" w-full absolute bottom-0   bg-black text-white px-4 py-2 rounded-sm opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                    ...
                    <h1 className="font-bold font-sans pt-2">Men Shirt </h1>
